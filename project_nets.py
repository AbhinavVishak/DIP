...
def test_mlp(learning_rate=0.01, L1_reg=0.00,L2_reg=0.0001,n_epochs=1000,batch_size=20,n_hidden=500,savemodel=True,verbose=False,nhl=1):
...
def test_lenet(learning_rate=0.1, n_epochs=200,nkerns=[20, 50], batch_size=500,verbose=True,savemodel=True):
